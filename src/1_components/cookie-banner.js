...
const CookieConsent = () => {
   ...
   return (
      <>
         {!bannerHidden && (
            <div className="z-50 w-full 2xl:w-auto bottom-0 left-1/2 -translate-x-1/2 backdrop-blur-sm bg-dark/70 text-center fixed py-3 md:py-2.5 px-2 md:px-6 rounded-t-md text-sm md:text-base leading-less">
